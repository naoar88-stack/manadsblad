      ...
      <div className="max-w-screen-2xl mx-auto bg-white/80 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_rgba(15,23,42,0.08)] rounded-[28px] px-5 py-3 flex flex-col sm:flex-row items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`h-10 px-4 rounded-2xl border text-sm font-medium flex items-center gap-1.5 transition ${
          ...
          <div className="flex flex-col items-end">
            {isAnon && <span className="text-[10px] text-amber-500 font-medium">Anonymt konto</span>}
            <button onClick={onLogout} className="h-10 px-4 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold flex items-center gap-1.5 transition">
