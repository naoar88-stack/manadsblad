        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Klistra in text — Gemini AI skapar aktiviteterna</p>
            </div>
          ...
          {!hasKey && (
            <div className="rounded-2xl bg-amber-50 border border-amber-100 px-4 py-3 text-sm text-amber-700 mb-4">
              <strong>VITE_GEMINI_API_KEY</strong> saknas i .env — Magic Paste kräver en Gemini API-nyckel.
            </div>
          )}
          ...
          <div className="flex gap-3 mt-4">
            ...
            >
              {aiLoading ? <><Loader2 className="w-4 h-4 animate-spin" />Analyserar…</> : <><Sparkles className="w-4 h-4" />Importera aktiviteter</>}
            </button>
          </div>
        </div>
      </div>
