...
export const BentoDayCard = ({ day, activities, onDropActivity, onRemoveActivity }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 flex-grow">
        {activities?.map((act) => (
          <div key={act.uniqueId} className={`group flex items-center justify-between p-2 rounded-xl text-xs font-medium ${act.color} bg-opacity-40`}>
